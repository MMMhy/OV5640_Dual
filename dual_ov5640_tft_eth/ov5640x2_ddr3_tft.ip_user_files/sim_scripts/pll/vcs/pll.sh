...
#
# Generated by Vivado on Wed Feb 23 23:54:34 +0800 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../ov5640x2_ddr3_tft.srcs/sources_1/ip/pll" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../ov5640x2_ddr3_tft.srcs/sources_1/ip/pll" \
    "$ref_dir/../../../../ov5640x2_ddr3_tft.srcs/sources_1/ip/pll/pll_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
